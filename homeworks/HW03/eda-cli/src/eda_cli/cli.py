...
def report(
    ...
    top_k_categories: int = typer.Option(5, help="Количество топ значений категорий для вывода."),
    ...
    with md_path.open("w", encoding="utf-8") as f:
        ...
        if not problematic_cols.empty:
            ...
            for col_name in problematic_cols.index:
                share = problematic_cols.loc[col_name, "missing_share"]
                f.write(f"- **{col_name}**: {share:.2%} пропусков\n")
            f.write("\n")
